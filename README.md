...
## Documentation for Models
 ...
 - [Freeclimb::SayClassic](docs/SayClassic.md)
 - [Freeclimb::SayElevenLabs](docs/SayElevenLabs.md)
 - [Freeclimb::SayElevenLabsEngine](docs/SayElevenLabsEngine.md)
 - [Freeclimb::SayElevenLabsEngineParameters](docs/SayElevenLabsEngineParameters.md)
 - [Freeclimb::SayElevenLabsEngineParametersPronunciationDictionaryInner](docs/SayElevenLabsEngineParametersPronunciationDictionaryInner.md)
 - [Freeclimb::SayElevenLabsEngineParametersVoiceSettings](docs/SayElevenLabsEngineParametersVoiceSettings.md)
 - [Freeclimb::SayNeural](docs/SayNeural.md)
 - [Freeclimb::SayNeuralEngine](docs/SayNeuralEngine.md)
 - [Freeclimb::SayNeuralEngineParameters](docs/SayNeuralEngineParameters.md)
 - [Freeclimb::SayNeuralTextType](docs/SayNeuralTextType.md)
 - [Freeclimb::SayStandard](docs/SayStandard.md)
 - [Freeclimb::SayStandardContentType](docs/SayStandardContentType.md)
 - [Freeclimb::SayStandardCulture](docs/SayStandardCulture.md)
 - [Freeclimb::SayStandardEngine](docs/SayStandardEngine.md)
 - [Freeclimb::SayStandardEngineParameters](docs/SayStandardEngineParameters.md)
 - [Freeclimb::SayStandardVoice](docs/SayStandardVoice.md)
