...
describe "SignatureInformation" do
  before do
    @request_header = "t=#{$time_stamp},v1=2f33654710a27e57828fa8556c2ed47c7a324aca88f155e296579e2ae851ce7b,v1=1ba18712726898fbbe48cd862dd096a709f7ad761a5bab14bda9ac24d963a6a8"
  ...
  describe "#is_request_time_valid" do
    context "request time is within tolerance threshold" do
      it "returns true" do
        ...
        @request_header = "t=#{@time_calculation},v1=2f33654710a27e57828fa8556c2ed47c7a324aca88f155e296579e2ae851ce7b,v1=1ba18712726898fbbe48cd862dd096a709f7ad761a5bab14bda9ac24d963a6a8"
        @signature_information_object = Freeclimb::SignatureInformation.new(@request_header)
        tolerance = 5 * 60
