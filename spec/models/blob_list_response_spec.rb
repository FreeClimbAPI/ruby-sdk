...
# Unit tests for Freeclimb::BlobListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Freeclimb::BlobListResponse do
  let(:instance) { Freeclimb::BlobListResponse.new }

  describe "test an instance of BlobListResponse" do
    it "should create an instance of BlobListResponse" do
      expect(instance).to be_instance_of(Freeclimb::BlobListResponse)
    end
  end
  ...
  describe 'test attribute "blobs"' do
    it "should work" do
      instance.blobs = ["ELEMENT_1", "ELEMENT_2"]
      expect(instance.blobs).to eq(["ELEMENT_1", "ELEMENT_2"])
    end
  end
  ...
  describe 'test method "initialize"' do
    it "properly initializes with values" do
      expect {
        Freeclimb::BlobListResponse.new(
          total: 1,
    ...
    it "fails to initialize with input argument that is not a hash in Freeclimb::BlobListResponse" do
      expect {
        Freeclimb::BlobListResponse.new(
          total: 1,
  ...
  describe 'test method "eql?"' do
    it "checks if objects are equal" do
      instance_1 = Freeclimb::BlobListResponse.new(
        total: 1,
      ...
      instance_2 = Freeclimb::BlobListResponse.new(
        total: 1,
  ...
  describe 'test method "_deserialize"' do
    ...
    it "deserializes the data of blobs" do
      expect(instance._deserialize("Array<BlobResult>", instance.blobs)).to be_a_kind_of(Array)
    end
  end
  ...
  describe 'test method "_to_hash"' do
    ...
    it "returns blobs in the form of hash" do
      expect(instance._to_hash(instance.blobs)).to eq(instance.blobs)
    end
  end
end
