...
# Unit tests for Freeclimb::OutDialAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OutDialAllOf' do
  before do
  ...
  describe 'test an instance of OutDialAllOf' do
    it 'should create an instance of OutDialAllOf' do
      expect(@instance).to be_instance_of(Freeclimb::OutDialAllOf)
    end
  end
