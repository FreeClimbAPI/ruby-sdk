...
# Unit tests for OpenapiClient::ApplicationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApplicationRequest' do
  before do
    # run before each test
    @instance = OpenapiClient::ApplicationRequest.new
  end
  ...
  describe 'test an instance of ApplicationRequest' do
    it 'should create an instance of ApplicationRequest' do
      expect(@instance).to be_instance_of(OpenapiClient::ApplicationRequest)
    end
  end
