...
# Unit tests for OpenapiClient::IncomingNumberList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IncomingNumberList' do
  before do
    # run before each test
    @instance = OpenapiClient::IncomingNumberList.new
  end
  ...
  describe 'test an instance of IncomingNumberList' do
    it 'should create an instance of IncomingNumberList' do
      expect(@instance).to be_instance_of(OpenapiClient::IncomingNumberList)
    end
  end
