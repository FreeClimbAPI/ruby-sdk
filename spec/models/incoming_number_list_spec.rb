...
describe Freeclimb::IncomingNumberList do
  ...
  describe 'test method "eql?"' do
    it 'checks if objects are equal' do
      ...
      instance_1 = Freeclimb::IncomingNumberList.new(
          ...
          page_size: 1,
          next_page_uri: "TS",
          incoming_phone_numbers: Freeclimb::IncomingNumberResult.new(),
  ...
  describe 'test method "_deserialize"' do
    ...
    it 'deserializes the data of incoming_phone_numbers' do
      expect(instance._deserialize("Array<IncomingNumberResult>", instance.incoming_phone_numbers)).to be_a_kind_of(Array)
    end
  end
