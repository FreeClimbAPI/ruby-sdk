...
# Unit tests for OpenapiClient::ApplicationResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApplicationResult' do
  before do
    # run before each test
    @instance = OpenapiClient::ApplicationResult.new
  end
  ...
  describe 'test an instance of ApplicationResult' do
    it 'should create an instance of ApplicationResult' do
      expect(@instance).to be_instance_of(OpenapiClient::ApplicationResult)
    end
  end
