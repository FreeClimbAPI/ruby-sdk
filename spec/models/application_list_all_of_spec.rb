...
# Unit tests for OpenapiClient::ApplicationListAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApplicationListAllOf' do
  before do
    # run before each test
    @instance = OpenapiClient::ApplicationListAllOf.new
  end
  ...
  describe 'test an instance of ApplicationListAllOf' do
    it 'should create an instance of ApplicationListAllOf' do
      expect(@instance).to be_instance_of(OpenapiClient::ApplicationListAllOf)
    end
  end
