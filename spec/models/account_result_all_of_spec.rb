...
# Unit tests for OpenapiClient::AccountResultAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountResultAllOf' do
  before do
    # run before each test
    @instance = OpenapiClient::AccountResultAllOf.new
  end
  ...
  describe 'test an instance of AccountResultAllOf' do
    it 'should create an instance of AccountResultAllOf' do
      expect(@instance).to be_instance_of(OpenapiClient::AccountResultAllOf)
    end
  end
