...
# Unit tests for OpenapiClient::ConferenceParticipantResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ConferenceParticipantResult' do
  before do
    # run before each test
    @instance = OpenapiClient::ConferenceParticipantResult.new
  end
  ...
  describe 'test an instance of ConferenceParticipantResult' do
    it 'should create an instance of ConferenceParticipantResult' do
      expect(@instance).to be_instance_of(OpenapiClient::ConferenceParticipantResult)
    end
  end
