...
# Unit tests for Freeclimb::SayNeural
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Freeclimb::SayNeural do
  let(:instance) { Freeclimb::SayNeural.new }

  describe "test an instance of SayNeural" do
    it "should create an instance of SayNeural" do
      expect(instance).to be_instance_of(Freeclimb::SayNeural)
    end
  end
  ...
  describe 'test attribute "engine"' do
    it "should work" do
      instance.engine = SayNeuralEngine.new
      expect(instance.engine).to be_instance_of(SayNeuralEngine)
    end
  end
    ...
    it "properly initializes with values" do
      expect {
        Freeclimb::SayNeural.new(
          ...
          engine: SayNeuralEngine.new
        )
      }.not_to raise_error
    end
    it "fails to initialize with input argument that is not a hash in Freeclimb::SayNeural" do
      expect {
        Freeclimb::SayNeural.new(
          text: "TS",
  ...
  describe 'test method "eql?"' do
    it "checks if objects are equal" do
      obj_SayNeuralEngine = SayNeuralEngine.new

      instance_1 = Freeclimb::SayNeural.new(
        text: "TS",
        ...
        engine: obj_SayNeuralEngine
      )
      instance_2 = Freeclimb::SayNeural.new(
        text: "TS",
  ...
  describe 'test method "_deserialize"' do
    ...
    it "deserializes the data of engine" do
      expect(instance._deserialize("Object", instance.engine)).to be_a_kind_of(SayNeuralEngine)
    end
  end
