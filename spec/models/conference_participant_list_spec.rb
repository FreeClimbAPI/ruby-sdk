...
# Unit tests for OpenapiClient::ConferenceParticipantList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ConferenceParticipantList' do
  before do
    # run before each test
    @instance = OpenapiClient::ConferenceParticipantList.new
  end
  ...
  describe 'test an instance of ConferenceParticipantList' do
    it 'should create an instance of ConferenceParticipantList' do
      expect(@instance).to be_instance_of(OpenapiClient::ConferenceParticipantList)
    end
  end
