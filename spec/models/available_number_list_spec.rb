...
describe Freeclimb::AvailableNumberList do
  ...
  describe 'test method "eql?"' do
    it 'checks if objects are equal' do
      ...
      instance_1 = Freeclimb::AvailableNumberList.new(
          ...
          page_size: 1,
          next_page_uri: "TS",
          available_phone_numbers: Freeclimb::AvailableNumber.new(),
  ...
  describe 'test method "_deserialize"' do
    ...
    it 'deserializes the data of available_phone_numbers' do
      expect(instance._deserialize("Array<AvailableNumber>", instance.available_phone_numbers)).to be_a_kind_of(Array)
    end
  end
