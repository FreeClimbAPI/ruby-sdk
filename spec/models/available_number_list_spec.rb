...
# Unit tests for OpenapiClient::AvailableNumberList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AvailableNumberList' do
  before do
    # run before each test
    @instance = OpenapiClient::AvailableNumberList.new
  end
  ...
  describe 'test an instance of AvailableNumberList' do
    it 'should create an instance of AvailableNumberList' do
      expect(@instance).to be_instance_of(OpenapiClient::AvailableNumberList)
    end
  end
