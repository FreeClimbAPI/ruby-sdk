...
# Unit tests for OpenapiClient::MakeCallRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MakeCallRequest' do
  before do
    # run before each test
    @instance = OpenapiClient::MakeCallRequest.new
  end
  ...
  describe 'test an instance of MakeCallRequest' do
    it 'should create an instance of MakeCallRequest' do
      expect(@instance).to be_instance_of(OpenapiClient::MakeCallRequest)
    end
  end
