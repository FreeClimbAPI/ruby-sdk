...
# Unit tests for Freeclimb::SayElevenLabs
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Freeclimb::SayElevenLabs do
  let(:instance) { Freeclimb::SayElevenLabs.new }

  describe "test an instance of SayElevenLabs" do
    it "should create an instance of SayElevenLabs" do
      expect(instance).to be_instance_of(Freeclimb::SayElevenLabs)
    end
  end
  ...
  describe 'test attribute "engine"' do
    it "should work" do
      instance.engine = SayElevenLabsEngine.new
      expect(instance.engine).to be_instance_of(SayElevenLabsEngine)
    end
  end
    ...
    it "properly initializes with values" do
      expect {
        Freeclimb::SayElevenLabs.new(
          ...
          engine: SayElevenLabsEngine.new
        )
      }.not_to raise_error
    end
    it "fails to initialize with input argument that is not a hash in Freeclimb::SayElevenLabs" do
      expect {
        Freeclimb::SayElevenLabs.new(
          text: "TS",
  ...
  describe 'test method "eql?"' do
    it "checks if objects are equal" do
      obj_SayElevenLabsEngine = SayElevenLabsEngine.new

      instance_1 = Freeclimb::SayElevenLabs.new(
        text: "TS",
        ...
        engine: obj_SayElevenLabsEngine
      )
      instance_2 = Freeclimb::SayElevenLabs.new(
        text: "TS",
  ...
  describe 'test method "_deserialize"' do
    ...
    it "deserializes the data of engine" do
      expect(instance._deserialize("Object", instance.engine)).to be_a_kind_of(SayElevenLabsEngine)
    end
  end
