...
# Unit tests for Freeclimb::RecordUtteranceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RecordUtteranceAllOf' do
  before do
  ...
  describe 'test an instance of RecordUtteranceAllOf' do
    it 'should create an instance of RecordUtteranceAllOf' do
      expect(@instance).to be_instance_of(Freeclimb::RecordUtteranceAllOf)
    end
  end
