...
# Unit tests for OpenapiClient::QueueMemberList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'QueueMemberList' do
  before do
    # run before each test
    @instance = OpenapiClient::QueueMemberList.new
  end
  ...
  describe 'test an instance of QueueMemberList' do
    it 'should create an instance of QueueMemberList' do
      expect(@instance).to be_instance_of(OpenapiClient::QueueMemberList)
    end
  end
