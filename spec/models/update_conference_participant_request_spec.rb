...
# Unit tests for OpenapiClient::UpdateConferenceParticipantRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UpdateConferenceParticipantRequest' do
  before do
    # run before each test
    @instance = OpenapiClient::UpdateConferenceParticipantRequest.new
  end
  ...
  describe 'test an instance of UpdateConferenceParticipantRequest' do
    it 'should create an instance of UpdateConferenceParticipantRequest' do
      expect(@instance).to be_instance_of(OpenapiClient::UpdateConferenceParticipantRequest)
    end
  end
