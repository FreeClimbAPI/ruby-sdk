...
# Unit tests for OpenapiClient::ConferenceResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ConferenceResult' do
  before do
    # run before each test
    @instance = OpenapiClient::ConferenceResult.new
  end
  ...
  describe 'test an instance of ConferenceResult' do
    it 'should create an instance of ConferenceResult' do
      expect(@instance).to be_instance_of(OpenapiClient::ConferenceResult)
    end
  end
