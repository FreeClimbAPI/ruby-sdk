module Freeclimb
    class RequestVerifier
        ...
        def self.check_request_body(request_body)
            if request_body == "" || request_body == nil
                raise 'Request Body cannot be empty or null'
            end
        end

        def self.check_request_header(request_header)
        ...
        def self.verify_signature(info, request_body, signing_secret)
        ...
        private_class_method :check_request_body, :check_request_header, :check_signing_secret, :check_tolerance, :verify_tolerance, :verify_signature
    end
end